...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void updateWatchFaceWeatherInfo() {
        ...
        Cursor weathercursor = context.getContentResolver().query(weatherUri, NOTIFY_WEATHER_PROJECTION, null, null, null);
        ...
        PutDataMapRequest weatherMapRequest = PutDataMapRequest.create(WEATHER_LOCATION);
        DataMap weatherDataMap = weatherMapRequest.getDataMap();
        weatherDataMap.putString(HIGH_TEMP, Utility.formatTemperature(context, weathercursor.getDouble(INDEX_MAX_TEMP)));
        weatherDataMap.putString(LOW_TEMP, Utility.formatTemperature(context, weathercursor.getDouble(INDEX_MIN_TEMP)));
        weatherDataMap.putInt(WEATHER_CONDITION, weathercursor.getInt(INDEX_WEATHER_ID));
